  ...
  return (
    <div className="space-y-8 relative z-0">
      ...
      <AnimationWrapper type="fade-down" duration={0.5}>
        <div>
          <h2 className="text-[40px] font-clash font-medium tracking-tight">Welcome back, Mr. Seller</h2>
        </div>
      </AnimationWrapper>
      ...
      <div className="grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12.5">
        <AnimationWrapper type="fade-up" duration={0.5} delay={0.05}>
          <StatCard icon={<Gavel className="text-primary w-6 h-6" />} count="2" label="Total Listing" />
        </AnimationWrapper>
        <AnimationWrapper type="fade-up" duration={0.5} delay={0.1}>
          <StatCard icon={<ListIcon className="text-primary w-6 h-6" />} count="1" label="Active Listings" />
        </AnimationWrapper>
        <AnimationWrapper type="fade-up" duration={0.5} delay={0.15}>
          <StatCard icon={<BadgePercent className="text-primary w-6 h-6" />} count="3" label="Pending Approval" />
        </AnimationWrapper>
        <AnimationWrapper type="fade-up" duration={0.5} delay={0.2}>
          <StatCard icon={<Heart className="text-primary w-6 h-6" />} count="8" label="Offer Receieved" />
        </AnimationWrapper>
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center border-b border-[#2C2C2E]/60 pb-6">
                <div>
                  <h4 className="font-medium text-gray-200 m-0 text-[20px] mb-2" >You placed a bid on Ferrari 488 Spider</h4>
                  <p className="text-[14px] text-gray-300">Your listing for 'Modern Luxury Mansion' is now live</p>

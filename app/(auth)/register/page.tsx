    ...
    <div className="min-h-screen bg-black flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 lg:p-20 relative z-10">
        <motion.div 
          ...
          className="w-full max-w-lg bg-[#111111] border border-[#D4AF37]/20 p-10 md:p-12 rounded-2xl shadow-2xl"
        >
          <div className="mb-10">
            <h4 className="text-[#D4AF37] text-xs font-bold uppercase tracking-[0.2em] mb-4">Register</h4>
            <h2 className="text-4xl font-serif text-white mb-2">Join Exoticworld</h2>
          ...
          <form className="space-y-2">
            ...
            <div className="space-y-4 pt-4">
              <Link href="/login">
                <button className="w-full cursor-pointer bg-[#D4AF37] text-black font-bold py-3 rounded-lg hover:bg-white transition-all duration-300 shadow-[0_0_30px_rgba(212,175,55,0.2)]">
                Create Account
              </button>
              </Link>
              
              <button type="button" className="w-full cursor-pointer border mt-4 border-white/10 bg-transparent py-3 rounded-lg flex items-center justify-center gap-3 text-white/80 text-sm font-medium hover:bg-white/5 transition-all">

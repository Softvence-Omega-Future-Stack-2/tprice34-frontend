...
export default function MyBidsPage() {
  ...
  const [selectedBidId, setSelectedBidId] = useState(bids[1].id); // Default to Ferrari
    ...
    <div className="mx-auto relative z-0">
      ...
      <div className="flex items-start justify-between mb-10">
        <AnimationWrapper type="fade-down" duration={0.5}>
          <div>
            <h2 className="text-[40px] font-clash font-semibold text-white">
              My Bids
            </h2>
      ...
      <div className="flex gap-12">
        ...
        <div className="flex-1">
          <div className="grid grid-cols-[1fr_repeat(3,100px)_150px] gap-4 mb-6 px-4">
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-10 rounded-lg overflow-hidden bg-black shrink-0 border border-white/5">
                  ...
                  <div className="flex items-center justify-end gap-2 pr-2">
                    {bid.status === "Outbid" && (
                      <button className="p-2.5 bg-[#E78F23]/10 hover:bg-[#E78F23]/20 text-[#E78F23] rounded-lg transition-colors border border-[#E78F23]/20 group/btn">
                        <ArrowUpRight className="w-4 h-4 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                      </button>
                    )}
                    <button className="flex items-center gap-2 px-4 py-2.5 bg-white/5 hover:bg-white/10 text-white text-[11px] font-bold rounded-lg border border-white/5 transition-all whitespace-nowrap">
                      View Details <Eye className="w-3.5 h-3.5 text-gray-400" />
                    </button>
                  </div>
                </div>
              </AnimationWrapper>
            ...
            <div className="space-y-6 sticky top-8">
                ...
                <div className="pt-6 border-t border-white/5">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <p className="text-[32px] font-clash font-medium text-[#E78F23] leading-none mb-1 tracking-tight">{selectedBid.priceSummary.totalPayable}</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                {selectedBid.specs.map((spec, i) => (
                  <div key={i} className="bg-[#161618] rounded-xl p-4 border border-white/5">
                    <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-1">{spec.label}</p>
                    <p className="text-[15px] font-medium text-white">{spec.value}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="bg-[#161618] rounded-xl p-4 flex items-center gap-3.5 border border-white/5">
                ...
                <div>
                  <p className="text-sm font-semibold text-white leading-none mb-1">{selectedBid.seller.name}</p>
              ...
              <div className="space-y-3 pt-2">
                ...
                <button className="w-full flex items-center justify-center gap-2 py-4.5 bg-transparent border border-white/10 hover:bg-white/5 text-white text-[13px] font-bold rounded-xl transition-all active:scale-[0.98]">
